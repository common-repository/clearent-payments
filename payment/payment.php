...
class payment {
    ...
    public $default_atts = array(
        ...
        "email_receipt_label" => "Email Receipt",
    ...
    public function clearent_pay_form($atts, $content, $tag) {
        ...
        $form .= '<tr>
                    <td><label for="email-receipt">' . $a['email-receipt-label'] . '</label></td>
                    <td>
                      <input type="checkbox" id="email-receipt" name="email-receipt" value="" />
                    </td>
                  </tr>';
        ...
        if (is_bool($a['email-address']) && $a['email-address'] != false) {
            ...
            $form .= '<tr style="display:none" id="email-address-line">
                        <td><label for="email-address">' . $a['email-address-label'] . '</label></td>
                        <td>
                          <input type="text" id="email-address" name="email-address" value="" />
                        </td>
    ...
    public function validate() {
        ...
        $email_receipt = $_REQUEST["email-receipt"] && $_REQUEST["email-receipt"] != "false";
    ...
    public function send() {
        ...
        $payment_data["email-receipt"] = $_REQUEST["email-receipt"];
        ...
        $values = array(
            ...
            "email_receipt" => $payment_data["email-receipt"],
